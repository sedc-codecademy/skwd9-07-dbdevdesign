USE [master]
GO
IF EXISTS (SELECT name FROM sys.databases WHERE name = N'SEDCHome_2020_G4')
	ALTER DATABASE [SEDCHome_2020_G4] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
GO
USE [Master]
GO
DROP DATABASE IF EXISTS [SEDCHome_2020_G4]
GO
CREATE DATABASE [SEDCHome_2020_G4]
GO
USE [SEDCHome_2020_G4]
GO
